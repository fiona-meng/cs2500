...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |hw1p1-starter (1)|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(define ACTUAL-OUTPUT (tosh "word"999999))
(define EXPECTED-OUTPUT (string->number "9"))
